...
const CONFIG = Object.freeze({
    ...
    ATTACKS: {
        ...
        'heavy_air_down': {
            ...
            combo: [
                { dmg: 12, force: 20, delay: 120 },
                { dmg: 12, force: 20, delay: 170 }
            ]
        },
    ...
    MAPS: {
        ...
        fptsoftware: {
            ...
            platforms: [
                { id: 'fpt_ground', x: 0, y: 620, w: 1600, h: 300, displayHeight: 300, imageAnchorY: 0, passThrough: false, imagePath: 'assets/maps/fptsoftware/platforms/plat_ground.png', imageKey: 'plat_fpt_ground' },
        ...
        voidrift: {
            ...
            platforms: [
                ...
                { id: 'vr_right_mid', x: 1040, y: 445, w: 140, h: 12, passThrough: true, phaseOnMs: 1520, phaseOffMs: 1280, phaseOffsetMs: 980 },
                { id: 'vr_top_left', x: 570, y: 305, w: 110, h: 12, passThrough: true, phaseOnMs: 1320, phaseOffMs: 1380, phaseOffsetMs: 240 },
                { id: 'vr_top_right', x: 900, y: 285, w: 110, h: 12, passThrough: true, phaseOnMs: 1350, phaseOffMs: 1320, phaseOffsetMs: 1030 },
                { id: 'vr_center_peak', x: 760, y: 190, w: 90, h: 12, passThrough: true, phaseOnMs: 900, phaseOffMs: 1700, phaseOffsetMs: 450 },
            ],
        },
    },
    ...
    // Tournament Tower (player clears fixed floors from easy -> boss)
    TOURNAMENT_TOWER: {
        OPPONENT_COUNT: 4,
        RANDOM_MAP_POOL: ['naruto', 'dragonball', 'fptsoftware'],
        FINAL_MAP_KEY: 'voidrift',
        BOSS: {
            name: 'OMEGA TITAN',
            difficulty: 1.0,
            aiLevel: 'hard',
    ...
    ULTIMATE_SKILLS: {
        ...
        fpt: {
            ...
            endDelay: 300,
            meteorCount: 15,
            meteorSpawnDuration: 3300,
            meteorHitboxRadius: 65,
            // Fraction of map width to randomize meteor X position (0 = no randomness, 1 = full width)
            meteorRandomness: 0.3,
